            ...
            <div className=' w-full lg:w-full xl:w-2/3 '>
                ...
                <div className=' flex flex-col md:flex-row lg:w-full  '>
                    <div className='bg-sky-200 flex-1 p-2 rounded-lg flex items-center gap-1 '>
                        <div className='w-1/3 '>
                            <img src="https://images.pexels.com/photos/1043474/pexels-photo-1043474.jpeg?auto=compress&cs=tinysrgb&w=1200" alt='img' width={100} height={100} className='w-24 h-24 rounded-full object-cover' />
                        </div>
                    ...
                    <div className='flex-1 md:flex items-center justify-around flex-wrap gap-3'>
                        <div className='flex gap-3 bg-white shadow-md p-4 rounded-md'>
