        ...
        return (
            <tr key={item.id} className=' border-b-2 text-sm hover:bg-purple-100 odd:bg-slate-50'>
                <td className='flex items-center gap-4 p-4'>
                    <img src={item.photo} alt='img' className='w-[40px] h-[40px] rounded-full hidden lg:block' />
                    <div>
                ...
                <td className='hidden md:table-cell text-sm text-gray-700 text-center'>{item.subjects}</td>
