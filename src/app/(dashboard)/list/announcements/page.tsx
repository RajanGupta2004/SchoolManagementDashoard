...
import { announcementsData, classesData, eventsData, examsData, parentsData, role, studentsData, teachersData } from '@/lib/data'
    ...
    return (
        <div className='p-2 rounded-md bg-white  mx-2 mt-0 '>
            ...
            <div className='w-full  '>
                <Table colums={colums} renderRow={renderRow} data={announcementsData} />
